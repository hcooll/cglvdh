package com.hc.hclvzh.api_baidu;
...
public class AuthService {
	...
	public static String getAuth() {
		...
		String clientId = "BpkXDLwB8SUTKWG11axiPTV8";
		// 官网获取的 Secret Key 更新为你注册的
		String clientSecret = "dah41MhVGj6klP2iSeiZzHGp3fw1HgVk";
...
//			String session_secret = jsonObject.optString("session_secret");
